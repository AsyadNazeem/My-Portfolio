                ...
                <div className='summary-about'>
                    ...
                    <div>
                        ...
                        <div className="summary-about-subheading">
                            <h4 className="summary-about-subheading">A dedicated Full Stack React Developer <br/> based
                                in
                                Colombo, Sri
                                Lanka.</h4>
                        </div>
                        <div className="summary-about-paragraph">
                            <p className="summary-about-paragraph">I'm a full-stack React developer based in Colombo,
                                Sri
